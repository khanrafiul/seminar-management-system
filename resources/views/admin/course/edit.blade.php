...
<div class="card" data-color="primary" id="wizardProfile">
  ...
  <div class="card-header mb-0">
    <div class="row">
      <div class="col-md-8">
        <h3 class="card-title text-secondary form-card-title-one"><i class="fa fa-cubes"></i> Edit Course</h3>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-sm-10">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="checkbox" class="@error('status') is-invalid @enderror" name="status" {{ $course->status==1 ? 'checked' : '' }}>
                <span>Published</span>
                @error('status')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
